...
public class ParamsGizmoDrawer : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            DrawSightArc(new Color32(0, 0, 255, 64), _controller.Params.SightRadius);
    ...
    {
        Vector3 dir = Quaternion.Euler(0, 0, -_controller.Params.SightAngle / 2) * _eye.right;

        UnityEditor.Handles.color = color;
        UnityEditor.Handles.DrawSolidArc(_eye.position, Vector3.forward, 
            dir, _controller.Params.SightAngle, radius);
    }
#endif
}
